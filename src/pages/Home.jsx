...
const Home = () => {
    ...
    const categoryID = "66452d6c1a0c8a5d5e51a000" // hard coded
    ...
    return (
        <React.Fragment>
            ...
            <div className=' '>
                ...
                {/*Section 2  */}
                <div className='bg-pure-greys-900 text-white '>
                    <div className='homepage_bg h-[310px]'>
                        <div className='w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-5 mx-auto'>
                            <div className='h-[150px]'></div>
                            <div className='flex flex-row gap-7 text-white bg '>
                                <CTAButton active={true} linkto={"/signup"}>
                        ...
                        <div className='flex flex-col lg:flex-row gap-5 mb-10 mt-[95px]'>
                            ...
                            <div className='flex flex-col gap-10 w-full lg:w-[40%] items-start'>
                                <div className='text-[16px]'>
                                    The modern EduStark is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.
                                </div>
                                <CTAButton active={true} linkto={"/signup"}>
                                    <div>
                                        Learn more
                ...
                {/*Section 3 */}
                <div className='mt-14 w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 first-letter bg-richblack-200 text-black rounded-full'>
                    <InstructorSection />
